    ...
    <footer id="contact" className="bg-gradient-to-br from-gray-800 to-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          {/* ========================================
              RÉSEAUX SOCIAUX - SECTION DÉSACTIVÉE
              ======================================== */}
          {/* Décommentez cette section quand vous aurez créé vos pages Facebook/Instagram
          ...
          {/* <div>
            ...
            <div className="flex gap-4">
              <a
                href="https://www.facebook.com/VOTRE_PAGE_FACEBOOK"
                target="_blank"
              ...
              {/* Instagram - Décommentez si vous créez un compte */}
              {/* <a
