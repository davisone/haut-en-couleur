        ...
        headers: [
          // Content Security Policy - Protection contre XSS et injection de code
          {
            ...
            value: [
              ...
              "connect-src 'self' https://hcaptcha.com https://*.hcaptcha.com https://*.tile.openstreetmap.org https://www.google-analytics.com https://*.google-analytics.com https://maps.googleapis.com https://www.googletagmanager.com", // API calls + hCaptcha + Leaflet + Google Analytics + Google Maps API
